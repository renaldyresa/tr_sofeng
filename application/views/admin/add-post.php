                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-10 col-md-offset-1">
                            <div class="p-6">
                                <div class="">
                                    <form action="<?php echo base_url() ?>admin/add_post/add" method="post" enctype="multipart/form-data">
                                        <div class="form-group m-b-20">
                                            <label for="exampleInputEmail1">Judul</label>
                                            <input type="text" class="form-control" id="judul" name="judul" placeholder="Masukkan Nama Event" required>
                                        </div>
                                        <div class="form-group m-b-20">
                                            <label for="exampleInputEmail1">Kapasitas</label>
                                            <input type="number" class="form-control" id="kapasitas" name="kapasitas" placeholder="Masukkan Max Peserta (kosongkan jika tidak ada limit peserta)">
                                        </div>
                                        <div class="form-group m-b-20">
                                            <label for="exampleInputEmail1">Harga</label>
                                            <input type="number" class="form-control" id="harga" name="harga" placeholder="Masukkan Harga Tiket">
                                        </div>
                                        <div class="form-group m-b-20">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="card-box">
                                                    ...
                                                    <label class="radio-inline"><input type="radio" name="status" value='0'>Non Active</label>
                                                </div>
                                            </div>
                                        </div>
